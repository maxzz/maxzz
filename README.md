...
-|-|-|-
[electron-react](https://github.com/maxzz/electron-react) | ```01.26.2023``` | ```01.30.2023``` | WIP
[forms-wreducer](https://github.com/maxzz/forms-wreducer) | ```01.15.2023``` | ```01.28.2023``` | [demo](https://maxzz.github.io/forms-wreducer)
[react-delay-unmount](https://github.com/maxzz/react-delay-unmount) | ```03.13.2021``` | ```01.25.2023``` | [demo](https://maxzz.github.io/react-delay-unmount)
...
[maxzz](https://github.com/maxzz/maxzz) | ```07.18.2020``` | ```01.23.2023``` | this page
[maxzz.github.io](https://github.com/maxzz/maxzz.github.io) | ```10.20.2021``` | ```01.26.2023``` | [demo](https://maxzz.github.io)
