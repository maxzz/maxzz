...
-|-|-|-
[noise-gen](https://github.com/maxzz/noise-gen) | ```05.26.2021``` | ```05.28.2021``` | [demo](https://maxzz.github.io/noise-gen/)
[ch-spy](https://github.com/maxzz/ch-spy) | ```06.16.2020``` | ```05.24.2021``` | [demo](https://maxzz.github.io/ch-spy/)
[css-3d](https://github.com/maxzz/css-3d) | ```05.06.2021``` | ```05.24.2021``` | [demo](https://maxzz.github.io/css-3d)
...
[maxzz](https://github.com/maxzz/maxzz) | ```07.18.2020``` | ```05.24.2021``` | this page
