...
-|-|-|-
[pmat24-lite](https://github.com/maxzz/pmat24-lite) | ```02.11.2024``` | ```06.23.2024``` | [demo](https://maxzz.github.io/pmat24-lite/)
...
[ngon-gen](https://github.com/maxzz/ngon-gen) | ```05.12.2020``` | ```06.18.2024``` | [demo](https://maxzz.github.io/ngon-gen)
[shadcn-tv](https://github.com/maxzz/shadcn-tv) | ```10.07.2023``` | ```06.17.2024``` | [demo](https://maxzz.github.io/shardcn-tv)
[gluehtml](https://github.com/maxzz/gluehtml) | ```05.27.2020``` | ```06.16.2024``` | [npm](https://www.npmjs.com/package/gluehtml)
...
[maxzz](https://github.com/maxzz/maxzz) | ```07.18.2020``` | ```06.22.2024``` | this page
