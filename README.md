...
-|-|-|-
[transitions](https://github.com/maxzz/transitions) | ```08.31.2026``` | ```09.06.2026``` | WIP
[tm-template-shadcn-26](https://github.com/maxzz/tm-template-shadcn-26) | ```05.07.2026``` | ```09.04.2026``` | [demo](https://maxzz.github.io/tm-template-shadcn-26/)
[win-watch-26-go](https://github.com/maxzz/win-watch-26-go) | ```06.27.2026``` | ```09.04.2026``` | [demo](https://maxzz.github.io/win-watch-26-go/)
[trace-viewer-26-go](https://github.com/maxzz/trace-viewer-26-go) | ```06.14.2026``` | ```08.29.2026``` | [demo](https://maxzz.github.io/trace-viewer-26-go/)
[traytools-26](https://github.com/maxzz/traytools-26) | ```06.18.2026``` | ```08.27.2026``` | WIP
[ch-spy](https://github.com/maxzz/ch-spy) | ```06.16.2020``` | ```08.25.2026``` | [demo](https://maxzz.github.io/ch-spy/)
[svg-path26](https://github.com/maxzz/svg-path26) | ```03.05.2026``` | ```07.17.2026``` | [demo](https://maxzz.github.io/svg-path26)
[to-diag-trace-go](https://github.com/maxzz/to-diag-trace-go) | ```06.10.2026``` | ```07.14.2026``` | [demo](https://maxzz.github.io/to-diag-trace-go/)
[pmat24-lite](https://github.com/maxzz/pmat24-lite) | ```02.11.2024``` | ```07.14.2026``` | [demo](https://maxzz.github.io/pmat24-lite/)
[win-watch-25](https://github.com/maxzz/win-watch-25) | ```01.25.2026``` | ```06.28.2026``` | WIP
[to-copy-no-nm-cli](https://github.com/maxzz/to-copy-no-nm-cli) | ```06.15.2026``` | ```06.28.2026``` | WIP
[tm-template-go-26-simple](https://github.com/maxzz/tm-template-go-26-simple) | ```06.25.2026``` | ```06.25.2026``` | WIP
[tw-az-go](https://github.com/maxzz/tw-az-go) | ```06.19.2026``` | ```06.21.2026``` | WIP
[tw-az](https://github.com/maxzz/tw-az) | ```06.14.2026``` | ```06.20.2026``` | WIP
[tm-template-go-26](https://github.com/maxzz/tm-template-go-26) | ```05.29.2026``` | ```06.18.2026``` | [demo](https://maxzz.github.io/tm-template-go-26/)
[gluehtml](https://github.com/maxzz/gluehtml) | ```05.27.2020``` | ```06.04.2026``` | [npm](https://www.npmjs.com/package/gluehtml)
[trace-viewer-25](https://github.com/maxzz/trace-viewer-25) | ```11.22.2025``` | ```06.03.2026``` | [demo](https://maxzz.github.io/trace-viewer-25/)
[trace-viewer-25-go](https://github.com/maxzz/trace-viewer-25-go) | ```06.01.2026``` | ```06.03.2026``` | WIP
[to-diag-trace-ne](https://github.com/maxzz/to-diag-trace-ne) | ```05.31.2026``` | ```05.31.2026``` | WIP
[singlefile-extractor-go](https://github.com/maxzz/singlefile-extractor-go) | ```05.14.2026``` | ```05.31.2026``` | WIP
[to-bin-copy-go](https://github.com/maxzz/to-bin-copy-go) | ```05.27.2026``` | ```05.28.2026``` | WIP
[page-qa2](https://github.com/maxzz/page-qa2) | ```03.05.2022``` | ```05.26.2026``` | [demo](https://maxzz.github.io/page-qa2)
[pm-tests-piggybacks](https://github.com/maxzz/pm-tests-piggybacks) | ```05.16.2026``` | ```05.26.2026``` | [demo](https://maxzz.github.io/pm-tests-piggybacks)
[pm-manifest](https://github.com/maxzz/pm-manifest) | ```07.03.2023``` | ```05.23.2026``` | WIP
[singlefile-extractor](https://github.com/maxzz/singlefile-extractor) | ```05.13.2026``` | ```05.14.2026``` | WIP
[convert-to-excalidraw-1](https://github.com/maxzz/convert-to-excalidraw-1) | ```05.11.2026``` | ```05.12.2026``` | WIP
[rollup-plugin-replace-regex](https://github.com/maxzz/rollup-plugin-replace-regex) | ```07.27.2023``` | ```05.07.2026``` | [npm](https://www.npmjs.com/package/rollup-plugin-replace-regex)
[svg-path](https://github.com/maxzz/svg-path) | ```12.21.2021``` | ```04.16.2026``` | [demo](https://maxzz.github.io/svg-path)
[manage-dpagent](https://github.com/maxzz/manage-dpagent) | ```03.30.2026``` | ```04.04.2026``` | WIP
[electron-window-monitor](https://github.com/maxzz/electron-window-monitor) | ```06.16.2023``` | ```03.02.2026``` | [demo](https://maxzz.github.io/electron-window-monitor)
[win-mon-copy](https://github.com/maxzz/win-mon-copy) | ```12.19.2025``` | ```02.13.2026``` | WIP
[ngon-gen](https://github.com/maxzz/ngon-gen) | ```05.12.2020``` | ```02.03.2026``` | [demo](https://maxzz.github.io/ngon-gen)
[ui-small-tests](https://github.com/maxzz/ui-small-tests) | ```10.14.2025``` | ```01.24.2026``` | [demo](https://maxzz.github.io/ui-small-tests)
[netsh-rule](https://github.com/maxzz/netsh-rule) | ```07.13.2020``` | ```01.20.2026``` | [npm](https://www.npmjs.com/package/netsh-rule)
[whatjsx-1](https://github.com/maxzz/whatjsx-1) | ```12.27.2025``` | ```12.30.2025``` | [demo](https://maxzz.github.io/whatjsx-1)
[back-to-90s](https://github.com/maxzz/back-to-90s) | ```09.13.2025``` | ```11.22.2025``` | WIP
[tailwindcss-plugin-overflow-tw4](https://github.com/maxzz/tailwindcss-plugin-overflow-tw4) | ```10.23.2025``` | ```10.26.2025``` | [npm](https://www.npmjs.com/package/tailwindcss-plugin-overflow-tw4)
[tailwindcss-plugin-debug-screens-tw4](https://github.com/maxzz/tailwindcss-plugin-debug-screens-tw4) | ```10.22.2025``` | ```10.26.2025``` | [npm](https://www.npmjs.com/package/tailwindcss-plugin-debug-screens-tw4)
[tailwindcss-plugin-markers-tw4](https://github.com/maxzz/tailwindcss-plugin-markers-tw4) | ```10.25.2025``` | ```10.26.2025``` | [npm](https://www.npmjs.com/package/tailwindcss-plugin-markers-tw4)
[tailwindcss-plugin-debug-screens](https://github.com/maxzz/tailwindcss-plugin-debug-screens) | ```10.15.2023``` | ```10.23.2025``` | WIP
[20250920-d3-hierarchical-edge-bundling](https://github.com/maxzz/20250920-d3-hierarchical-edge-bundling) | ```09.20.2025``` | ```10.02.2025``` | [demo](https://maxzz.github.io/20250920-d3-hierarchical-edge-bundling)
[update-env-upen](https://github.com/maxzz/update-env-upen) | ```09.25.2025``` | ```09.26.2025``` | WIP
[update-env](https://github.com/maxzz/update-env) | ```09.25.2025``` | ```09.25.2025``` | WIP
[back-to-90s-original](https://github.com/maxzz/back-to-90s-original) | ```09.15.2025``` | ```09.16.2025``` | WIP
[color-names23](https://github.com/maxzz/color-names23) | ```10.08.2023``` | ```09.12.2025``` | [demo](https://maxzz.github.io/color-names23)
[work-weeks](https://github.com/maxzz/work-weeks) | ```01.08.2021``` | ```09.11.2025``` | [npm](https://www.npmjs.com/package/work-weeks)
[topdirs](https://github.com/maxzz/topdirs) | ```11.03.2022``` | ```09.07.2025``` | WIP
[rarsrt](https://github.com/maxzz/rarsrt) | ```04.14.2021``` | ```09.07.2025``` | [npm](https://www.npmjs.com/package/rarsrt)
[make-topdirs](https://github.com/maxzz/make-topdirs) | ```09.04.2025``` | ```09.04.2025``` | WIP
[rardir](https://github.com/maxzz/rardir) | ```09.16.2020``` | ```09.04.2025``` | [npm](https://www.npmjs.com/package/rardir)
[pm-manifest-icons-test](https://github.com/maxzz/pm-manifest-icons-test) | ```06.17.2025``` | ```09.04.2025``` | WIP
[dropzone](https://github.com/maxzz/dropzone) | ```09.16.2021``` | ```08.30.2025``` | [demo](https://maxzz.github.io/dropzone)
[shadcn-tv](https://github.com/maxzz/shadcn-tv) | ```10.07.2023``` | ```08.30.2025``` | [demo](https://maxzz.github.io/shardcn-tv)
[pm-manifest-icons](https://github.com/maxzz/pm-manifest-icons) | ```07.08.2023``` | ```08.23.2025``` | WIP
[tm-react-popper-tooltip](https://github.com/maxzz/tm-react-popper-tooltip) | ```07.18.2025``` | ```08.17.2025``` | WIP
[electron-vite-v4-2025](https://github.com/maxzz/electron-vite-v4-2025) | ```08.01.2025``` | ```08.01.2025``` | WIP
[pmac](https://github.com/maxzz/pmac) | ```09.02.2022``` | ```07.28.2025``` | [demo](https://maxzz.github.io/pmac)
[electron-react](https://github.com/maxzz/electron-react) | ```01.26.2023``` | ```06.19.2025``` | [demo](https://maxzz.github.io/electron-react)
[electron-vite-2025](https://github.com/maxzz/electron-vite-2025) | ```04.29.2025``` | ```05.10.2025``` | WIP
...
[maxzz2024](https://github.com/maxzz/maxzz2024) | ```08.22.2025``` | ```08.22.2025``` | [demo](https://maxzz.github.io/maxzz2024)
[maxzz](https://github.com/maxzz/maxzz) | ```07.18.2020``` | ```08.31.2026``` | this page
[maxzz.github.io](https://github.com/maxzz/maxzz.github.io) | ```10.20.2021``` | ```09.04.2026``` | [demo](https://maxzz.github.io)
