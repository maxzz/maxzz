...
-|-|-|-
[pmat24-lite](https://github.com/maxzz/pmat24-lite) | ```02.11.2024``` | ```05.04.2024``` | [demo](https://maxzz.github.io/pmat24-lite/)
[dropzone](https://github.com/maxzz/dropzone) | ```09.16.2021``` | ```05.04.2024``` | [demo](https://maxzz.github.io/dropzone)
[rardir](https://github.com/maxzz/rardir) | ```09.16.2020``` | ```05.03.2024``` | [npm](https://www.npmjs.com/package/rardir)
[pm-manifest](https://github.com/maxzz/pm-manifest) | ```07.03.2023``` | ```05.02.2024``` | WIP
[shadcn-tv](https://github.com/maxzz/shadcn-tv) | ```10.07.2023``` | ```04.25.2024``` | [demo](https://maxzz.github.io/shardcn-tv)
...
[maxzz](https://github.com/maxzz/maxzz) | ```07.18.2020``` | ```04.29.2024``` | this page
